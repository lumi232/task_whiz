...
class Trainer:
    def __init__(self, preprocessor, output_dir):
        self.preprocessor = preprocessor
        self.output_dir = output_dir
        if not os.path.exists(output_dir):
            os.makedirs(output_dir)

    def train_stress_score(self):
        X_train, X_test, y_train, y_test = self.preprocessor.stress_score_preprocessing()
    ...
    def train_moral(self):
        X_train, X_test, y_train, y_test = self.preprocessor.moral_data_preprocessing()
    ...
    def train_completion_time(self):
        X_train, X_test, y_train, y_test = self.preprocessor.completion_time_preprocessor()
