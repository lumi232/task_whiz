...
class TaskAllocator:
    def __init__(self, bert_model_name, num_classes):
        ...
        model_checkpoint_path = '/content/drive/MyDrive/Task_Whiz/bert_classifier.pth'


        self.device = torch.device("cpu")
        self.tokenizer = BertTokenizer.from_pretrained(bert_model_name)
        self.model = BERTClassifier(bert_model_name, num_classes)
    ...
    def allocate_subtasks(self, subtasks_dict, data):
        ...
        for task_description, task_type in subtasks_dict.items():
            ...
            allocation_results[task_description] = allocation
